import{t as e}from"./md-ordinal-D4BAXFQA.js";import"./md-src-CgtiL2qV.js";import{t}from"./md-chunk-X3CZISLH-yj18HzkN.js";import{t as n}from"./md-arc-TU1ZWJXX.js";import{t as r}from"./md-pie-7laHeOse.js";import{i,p as a}from"./md-chunk-ICXQ74PX-SET67TIp.js";import{n as o}from"./md-chunk-Y2CYZVJY-DsF7k-Jl.js";import{H as s,K as c,U as l,a as u,c as d,f,v as p,w as m,x as h,y as g}from"./md-chunk-WYO6CB5R-C4Oiu6Zx.js";import{t as _}from"./md-chunk-VAUOI2AC-CkTdoN9v.js";import{t as v}from"./md-chunk-JWPE2WC7-qo9X49S-.js";import{n as y}from"./md-mermaid-parser.core-BxThQk2t.js";var b=f.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:o(()=>structuredClone(w),`getConfig`),clear:o(()=>{S=new Map,C=x.showData,u()},`clear`),setDiagramTitle:c,getDiagramTitle:m,setAccTitle:l,getAccTitle:g,setAccDescription:s,getAccDescription:p,addSection:o(({label:e,value:n})=>{if(n<0)throw Error(`"${e}" has invalid value: ${n}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,n),t.debug(`added new section: ${e}, with value: ${n}`))},`addSection`),getSections:o(()=>S,`getSections`),setShowData:o(e=>{C=e},`setShowData`),getShowData:o(()=>C,`getShowData`)},E=o((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:o(async e=>{let n=await y(`pie`,e);t.debug(n),E(n,T)},`parse`)},O=o(e=>`
  .pieCircle{
